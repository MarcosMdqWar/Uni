...
<head>
	...
	<script type="module">
		...
		const firebaseConfig = {
			...
			authDomain: "parcial1mdq.firebaseapp.com",
			projectId: "parcial1mdq",
			storageBucket: "parcial1mdq.appspot.com",
		...
		$(document).ready(function() {
			$('#cerrar_sesion').click(function() {
				signOut(auth).then(() => {
					...
					location.href = 'logout.php';//Aca redirije a index
					//NO PONER EL SESSION DESTROY ACA PORQUE BORRA LAS SESIONES
				}).catch((error) => {
	...
	<div class="container">
		<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom" id="Cab">
			...
			<ul class="nav nav-pills">
				...
				<li class="nav-item"><a href="home_principal.php"  class="nav-link">Principal</a></li>
...
<!-- <button type="button" class="btn btn-danger" onclick="location.href='home_principal.php';">
...
<div class="form-outline mb-4">
	<div class="container">
		<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
			<p class="col-md-4 mb-0 text-muted">&copy; Recu1</p>
