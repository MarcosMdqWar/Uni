 ...
 * Además, comprueba si los datos ingresados son validos antes de cargarlos en las tablas, y tambien im-
 * -prime un comprobante de pago cuando se agrega una orden de compra [!].
 * 
 */
public class MainFrame extends javax.swing.JFrame {
    Conexion conexion = new Conexion("localhost", "tpfinalmarcos", "root", "");
    public MainFrame() {
        setTitle("Gestión principal");
    ...
    private void initComponents() {
        ...
        jButton2.setText("Gestionar Proveedores");
        ...
        jButton4.setText("Gestionar Órdenes");
        ...
        jLabel1.setText("TP FINAL - Marcos Joel Depaula");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new GestionarProducto(conexion).setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new GestionarProveedores(conexion).setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new GestionarOrdenes(conexion).setVisible(true);
